...
//
    { // バックライト制御の設定を行います。（必要なければ削除）
      ...
      cfg.pin_bl = 13;              // バックライトが接続されているピン番号
...
///*
    { // タッチスクリーン制御の設定を行います。（必要なければ削除）
      ...
      cfg.x_min      = 100;    // タッチスクリーンから得られる最小のX値(生の値)
      cfg.x_max      = 4000;  // タッチスクリーンから得られる最大のX値(生の値)
      cfg.y_min      = 100;    // タッチスクリーンから得られる最小のY値(生の値)
      cfg.y_max      = 4000;  // タッチスクリーンから得られる最大のY値(生の値)
